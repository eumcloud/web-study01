...
!(function (t, e) {
    ...
    function Qt(t, e) {
        ...
        var f = u.reduce(function (e, i) {
            return (
                (e[i] = Yt(t, { placement: i, boundary: s, rootBoundary: o, padding: r })[pt(i)]), e
            );
        }, {});
    ...
    class Ie extends R {
        ...
        _getConfig(t) {
            return (
                (t = { ...Ne, ...U.getDataAttributes(this._element), ...t }), d('modal', t, Se), t
            );
        }
        _showElement(e) {
    ...
    class Me extends R {
        ...
        static jQueryInterface(t) {
            return this.each(function () {
                const e =
                    w.get(this, 'bs.offcanvas') || new Me(this, 'object' == typeof t ? t : {});
                if ('string' == typeof t) {
    ...
    class ri extends R {
        ...
        _setListeners() {
            H.on(this._element, 'click.dismiss.bs.toast', '[data-bs-dismiss="toast"]', () =>
                this.hide()
            ),
